    ...
    class UserAuthComponent extends Component
    {
        ...
        function beforeFilter(&$c)
        {
            ...
            $permissionFree = array(
                ...
                'restaurants/index',
                'restaurants/details',
                'restaurants/takeawaysCity',
                'restaurants/takeawaysCuisine',
                'restaurants/suggestRestaurant',
                'restaurants/suggestTakeaways',
                'restaurants/newTakeaways',
                'restaurants/pizzaDelivery',
                'restaurants/takeaways',
                'restaurants/allCuisineList',
                'restaurants/allCityList',
                'restaurants/searchTakeaways',
                'restaurants/getRestaurantListAutoComplete',
                'orders/ajaxAddToCart',
                'orders/displayCart',
                'orders/orderView',
                'chefCareers/currentOpening',
            ...
            if((empty($pageRedirect) || $actionUrl != 'users/login') && !$requested && !in_array($actionUrl, $permissionFree))
            {
                ...
                if(!$this->isLogged())
                {
                    if(!$userGroupModel->isGuestAccess($controller, $action))
                    {
                        ...
                        $c->Session->setFlash("You must login to view this page");
        ...
        public function persist($duration = '2 weeks')
        {
            ...
            return $this->Cookie->write(
                'UsermgmtCookie', $token, true, // encrypt = true
                $duration
            );
